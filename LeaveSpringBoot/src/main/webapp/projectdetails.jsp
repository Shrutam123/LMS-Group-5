            ...
            <div> <a href="adminhome.jsp" class="nav_logo"> <i class='bx bx-bar-chart-alt-2 nav_icon'></i> <span class="nav_logo-name">Admin</span> </a>
                <div class="nav_list"> 
                  <a href="employeedetails" class="nav_link active"> <i class='bx bx-grid-alt nav_icon'></i> <span class="nav_name">Manage Employees</span> </a> 
                    ...
                    <a href="projectdetails" class="nav_link"> <i class='bx bx-code-block'></i> <span class="nav_name">Project List</span> </a>
                    <a href="assignedprojectdetails" class="nav_link"> <i class='bx bxs-briefcase'></i><span class="nav_name">Project Details</span> </a>  
                ...
                <tbody>
                    <c:forEach items="${employees}" var="employee">
                        <tr>
                            ...
                            <td><a href="delete2?id=<c:out value='${employee.id }'/>">Revoke</a></td>
                        </tr>
                    </c:forEach>
                </tbody>
              </table>
