...
<body id="body-pd">
 ...
 <header class="header" id="header">
    ...
    <div class="l-navbar" id="nav-bar">
        <nav class="nav">
            <div> <a href="employeehome?id=${id }" class="nav_logo"> <i class='bx bx-bar-chart-alt-2 nav_icon'></i> <span class="nav_logo-name">Employee</span> </a>
                <div class="nav_list"> 
                 <a href="employeeprofile?id=${id }" class="nav_link "> <i class='bx bx-grid-alt nav_icon'></i> <span class="nav_name">Profile</span> </a>     
                 <a href="employeeapply?id=${id }" class="nav_link"> <i class='bx bx-message-alt'></i> <span class="nav_name">Apply Leave</span> </a>
                 <a href="leavehistory?eid=${id }" class="nav_link"><i class='bx bxs-stopwatch'></i> <span class="nav_name">Leave History</span> </a> 
                 <a href="holidaydetails1?id=${id }" class="nav_link"><i class='bx bxs-backpack'></i> <span class="nav_name">Holiday List</span> </a> 
                 
                 <a href="resetpwd1?id=${id }" class="nav_link"><i class='bx bxs-user'></i> <span class="nav_name">Reset Password</span> </a>
            </div>
    ...
    <section class="container-fluid bg ">
        ...
        <section class="col-12 col-sm-6 col-md-3">
            <form class="form-container" method="post"   action="reset" onsubmit="return validateForm()">
